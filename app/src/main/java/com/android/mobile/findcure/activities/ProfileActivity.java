...
public class ProfileActivity extends AppCompatActivity {
    ...
    private LinearLayout emailLayout, passwordLayout, confirmPPasswordLayout, titleLayout;
    private View emailView, passwordView, cpView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmPPasswordLayout = findViewById(R.id.confirmPasswordLayout);
        titleLayout = findViewById(R.id.layoutTitle);
        emailView = findViewById(R.id.emailView);
        passwordView = findViewById(R.id.passwordView);
        cpView = findViewById(R.id.cpView);
        alreadyTv = findViewById(R.id.alreadyText);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            confirmPPasswordLayout.setVisibility(View.GONE);
            emailView.setVisibility(View.GONE);
            passwordView.setVisibility(View.GONE);
            cpView.setVisibility(View.GONE);
            alreadyTv.setVisibility(View.GONE);
            btnSignIn.setVisibility(View.GONE);
            imageLogo.setVisibility(View.VISIBLE);
            btnSignup.setText(R.string.update_profile);
            pd.dismiss();
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    mAuth.getCurrentUser().sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            Intent intent = new Intent(ProfileActivity.this, VerifyActivity.class);
