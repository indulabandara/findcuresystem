...
public class findlocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        spType.setAdapter(new ArrayAdapter<>(findlocation.this, android.R.layout.simple_spinner_dropdown_item, placeNameList));

        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);

        if (ActivityCompat.checkSelfPermission(findlocation.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

            getCurrentLocation();
        }else {
            ActivityCompat.requestPermissions(findlocation.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},44);
        }
